...
//          final var sourceVal = this.value.toString();
//          final var str = convertStringToJava(sourceVal, ascii);
//          var bytes = StrSourceBytesCollector.get(sourceVal);
//          final var strBuf = new TextBuffer();
//          if (bytes != null) {
...
//
//            strBuf.append("/*")
//              .append(srcBytes.toString())
//              .append("*/");
//
//            strBuf.append(new TextBuffer(str).enclose("\"", "\""));
//          }
//          return strBuf;
