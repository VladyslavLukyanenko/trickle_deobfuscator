...
public class MethodProcessorRunnable implements Runnable {
  ...
  public void run() {
    ...
    try {
      ...
      root = codeToJava(klass, method, methodDescriptor, varProc, renamer);
    }
    catch (Throwable t) {
      error = t;
    }
  ...
  public static RootStatement codeToJava(StructClass cl, StructMethod mt, MethodDescriptor md, VarProcessor varProc,
                                         IIdentifierRenamer renamer) throws IOException {
    ...
    while (fProc.iterateGraph(cl, mt, root, graph, renamer)) {
    ...
    ExprProcessor proc = new ExprProcessor(md, varProc, renamer);
